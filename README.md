# Repo B1 — Tiếng Anh B1 & Game Sinh Nhật 🎂

Repository lưu 2 nội dung chính:

## 📚 1. Tài liệu học tiếng Anh B1 (Self-study / PET)
...
| Bản rút gọn PET | `Self-study-B1-PET-ban-rut-gon.docx` |
| Speaking Unit 2–5 | `Self-study-bai-lam-speaking-Unit2-5.docx/.pdf` |
| Chép nhanh Unit 4 → hết | `Chep-nhanh-Unit-4-den-het.docx/.pdf` |
| Chương 1 — bài tập | `Chuong1_BaiTap2.docx`, `Chuong1_BaiTap5.docx`, `Chuong1_Cau3.docx`, `Chuong1_Cau4.docx` |
| Chương 2 — bài tập + mindmap | `Chuong2_*.docx/.pdf/.png` |

## 🎮 2. Game pixel "Chúc Mừng Sinh Nhật Phương Mai"

Game platformer pixel đơn giản, tặng Đặng Hoàng Phương Mai nhân dịp sinh nhật.

- Chơi ngay: mở [`sinh-nhat-mai/index.html`](sinh-nhat-mai/index.html)
- Đi thẳng 1 đường, nhặt quà trên đường, nhảy qua vực sâu, đến đích mở quà 🎁
- Chạy trên cả điện thoại (cảm ứng) và máy tính (bàn phím)

Chi tiết xem [`sinh-nhat-mai/README.md`](sinh-nhat-mai/README.md).
